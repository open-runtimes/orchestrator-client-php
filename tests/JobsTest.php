    ...
    public function test_create_serializes_artifacts_and_callback(): void
    {
        ...
        $jobs->create(
            ...
            artifacts: [
                ...
                new ArchiveArtifact('image', 'stores', 'stores.erofs', format: ArchiveFormat::Erofs, compression: ArchiveCompression::Lz4hc, depends: 'job'),
        ...
        $this->assertJsonStringEqualsJsonString(
            (string) \json_encode([
                ...
                'artifacts' => [
                    ...
                    ['id' => 'image', 'type' => 'archive', 'depends' => 'job', 'in' => 'stores', 'out' => 'stores.erofs', 'format' => 'erofs', 'compression' => 'lz4hc'],
